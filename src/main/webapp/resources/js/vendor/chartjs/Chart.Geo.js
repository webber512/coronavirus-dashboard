(function (global, factory) {
  ...
  Chart.defaults.global.elements.geoFeature = Object.assign({}, Chart.defaults.global.elements.rectangle, defaults); // const superClass = Chart.Element.prototype;
  ...
  var superClass$1 = Chart.Scale.prototype;
  ...
  Chart.scaleService.registerScaleType('projection', ProjectionScale, defaults$2);
  ...
  var ColorScale = createScale(Chart.scaleService.getScaleConstructor('linear'));
  var ColorScaleLogarithmic = createScale(Chart.scaleService.getScaleConstructor('logarithmic'));
  Chart.scaleService.registerScaleType('color', ColorScale, Chart.helpers.merge({}, [Chart.scaleService.getScaleDefaults('linear'), baseDefaults, defaults$3]));
  Chart.scaleService.registerScaleType('colorLogarithmic', ColorScaleLogarithmic, Chart.helpers.merge({}, [Chart.scaleService.getScaleDefaults('logarithmic'), baseDefaults, defaults$3]));
    ...
    return superClassConstructor.extend(Object.assign(createBase(superClass), {
      ...
      _drawIndicator: function _drawIndicator() {
        ...
        values.forEach(function (v, i) {
          ...
          Chart.helpers.canvas.drawPoint(ctx, _this._model ? _this._model.pointStyle : null, radius, x, y, 0);
        });
      }
    }));
  }

  var SizeScale = createScale$1(Chart.scaleService.getScaleConstructor('linear'));
  var SizeScaleLogarithmic = createScale$1(Chart.scaleService.getScaleConstructor('logarithmic'));
  Chart.scaleService.registerScaleType('size', SizeScale, Chart.helpers.merge({}, [Chart.scaleService.getScaleDefaults('linear'), baseDefaults, defaults$4]));
  Chart.scaleService.registerScaleType('sizeLogarithmic', SizeScaleLogarithmic, Chart.helpers.merge({}, [Chart.scaleService.getScaleDefaults('logarithmic'), baseDefaults, defaults$4]));

  function resolveScale(chart, scaleOptions) {
    var scaleClass = Chart.scaleService.getScaleConstructor(scaleOptions.type);
  ...
  Chart.defaults.choropleth = Chart.helpers.configMerge(geoDefaults, defaults$5);
  ...
  Chart.defaults.bubbleMap = Chart.helpers.configMerge(geoDefaults, defaults$6);
